...
impl<H> CompositorHandler for Data<H>
where
...
impl<H> BufferHandler for Data<H>
where
  H: EventHandler,
{
...
delegate_compositor!(@<H: EventHandler> Data<H>);
delegate_shm!(@<H: EventHandler> Data<H>);
